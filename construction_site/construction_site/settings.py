...
SECRET_KEY = 'django-insecure-x6=$a%z*0)t563gmgr1w0h3vha6up)a*g2s0z9sf_1l20mq-du'
...
# Email Configuration - Now Securely Loaded from .env
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')  # ← Loaded from .env
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # ← Loaded from .env (secure!)
